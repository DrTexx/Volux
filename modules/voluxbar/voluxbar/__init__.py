...
class MainApplication(ttk.Frame):
    ...
    def _update_loop(self):
        ...
        # print("refreshing...")
        self.after(
            self.VoluxBar_obj._pollrate, self._update_loop
        )  # repeat _update_loop()
    ...
    def _middle_click(self, event):
        ...
        if hasattr(active_module, "toggle"):
            ...
            print(
                "module '{}' has no toggle method!".format(
...
class VolumeBar(ttk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.barValue = ttk.Frame(
            self, width=1920 * 0.5, height=100, style="BarVal.TFrame"
        )
        self.barValue.pack()
