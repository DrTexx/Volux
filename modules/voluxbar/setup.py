...
setuptools.setup(
    ...
    summary="volux module which produces an interactive bar overlay on the user's screen",  # Optional
    description="volux module which produces an interactive bar overlay on the user's screen",  # Optional
