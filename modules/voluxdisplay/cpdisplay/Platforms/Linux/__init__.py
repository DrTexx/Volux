...
class Display:
    ...
    def _gDisplayName(self):
        ...
        display_name = self.subprocess.call(
            ['xrandr | grep " connected"'], shell=True
        )
        print(display_name)
    ...
    def sbrightness(self, displayname, new_brightness):
        ...
        "xrandr --output {} --brightness {}".format(
            displayname, new_brightness
        )  # NOTE: CONTROLS LITERAL BRIGHTNESS, NOT BACKLIGHT BRIGHTNESS!!!
