...
setuptools.setup(
    ...
    summary="volux module for controlling audio mixers (i.e. volume/mute/etc.)",  # Optional
    description="volux module for controlling audio mixers (i.e. volume/mute/etc.)",  # Optional
    description_content_type="text/markdown",  # Optional
    author="Denver Pallis",
    author_email="DenverPallisProjects@gmail.com",
    license="GPLv3+",
    install_requires=["volux==0.9.16", "cpmixer==0.8.1"],
