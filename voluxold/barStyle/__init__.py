barstyles = {
    "Volume": {"name": "volume", "kwargs": {"background": "GREEN"}},
    "Muted": {"name": "muted", "kwargs": {"background": "RED"}},
    "Brightness": {"name": "brightness", "kwargs": {"background": "BLUE"}},
    "Unknown": {"name": "unknown", "kwargs": {"background": "GREY"}},
}
