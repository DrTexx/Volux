...
# package
from .parser import VoluxParser


def main() -> None:
    """Handle CLI interaction for Volux."""
    vparser = VoluxParser()
    vparser.handle_arguments(vparser.arguments)
...
if __name__ == "__main__":
    ...
    #     description="launches the volux GUI",
    # )
    ...
    #                 colorama.Fore.RED, arguments.LIST, colorama.Style.RESET_ALL
    #             )
    #         )
    #         print(
    ...
    #                 colorama.Fore.RED, arguments.DEMO, colorama.Style.RESET_ALL
    #             )
    #         )
    #         print(
    #             "{}Tip: See 'volux list demos'{}".format(
    #                 colorama.Fore.YELLOW, colorama.Style.RESET_ALL
    #             )
    #         )
